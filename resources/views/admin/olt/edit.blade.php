        ...
        <section class="section">
            <div class="section-header">
                <div class="section-header-back">
                    <a href="{{ route('admin.olt.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                </div>
                <h1>OLT</h1>
            ...
            <div class="section-body">
                <h2 class="section-title">Edit Data OLT</h2>
                        ...
                        <div class="col-md-12 ">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{ route('admin.olt.update', $olt->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="latitude" class="form-control"
                                                            name="latitude" placeholder="" value="{{ $olt->latitude }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="longitude" class="form-control"
                                                            name="longitude" placeholder="" value="{{ $olt->longitude }}">
                                                    </div>
