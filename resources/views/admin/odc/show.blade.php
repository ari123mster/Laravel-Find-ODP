                    ...
                    <div class="col-md-12 ">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ route('admin.odc.show', $odc->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 form-group">
                                                    <input type="text" id="longitude" class="form-control"
                                                        name="longitude" value="{{ $odc->longitude }}" readonly>
                                                </div>
    ...
    <script>
        ...
        function onLocationFound(e) {
            ...
            L.Routing.control({
                waypoints: [
                    L.latLng(e.latlng),
                    L.latLng({{ $odc->latitude }}, {{ $odc->longitude }})
                ]
            }).addTo(map);
        }
