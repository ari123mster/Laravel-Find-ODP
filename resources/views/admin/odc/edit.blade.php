        ...
        <section class="section">
            <div class="section-header">
                <div class="section-header-back">
                    <a href="{{ route('admin.odc.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                </div>
                <h1>odc</h1>
            ...
            <div class="section-body">
                <h2 class="section-title">Edit Data odc</h2>
                        ...
                        <div class="col-md-12 ">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{ route('admin.odc.update', $odc->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-body">
                                                <div class="row">
                                                        ...
                                                        <select class="form-control" name="olt_id">
                                                            ...
                                                            @foreach ($olt as $item)
                                                                <option value="{{ $item->id }}"
                                                                    @if ($odc->olt_id == $item->id) selected @endif>
                                                                    {{ $item->nama }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="latitude" class="form-control"
                                                            name="latitude" placeholder="" value="{{ $odc->latitude }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="longitude" class="form-control"
                                                            name="longitude" placeholder="" value="{{ $odc->longitude }}">
                                                    </div>
